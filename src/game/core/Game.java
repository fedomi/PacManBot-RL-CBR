...
public interface Game
{
	...
	public int getEdibleTimeRemaining();							//returns the edible time remaining for last power pill eated;
	...
	public boolean isCorner(int nodeIndex);							//returns true if node is a corner
